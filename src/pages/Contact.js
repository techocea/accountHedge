...
const Contact = () => {
    useEffect(() => emailjs.init("4gBzyLuHA2B14-pbn"), []);
    ...
    const serviceId = "service_nl0lx7h";
    const templateId = "template_jnozq8m";
    try {
      //setLoading(true);
      ...
      //setLoading(false);
        ...
        // await  emailjs
        //     .sendForm('service_nl0lx7h', 'template_jnozq8m', fData)
        //     .then(
        //     () => {
        //     console.log('SUCCESS!');
        //     alert('Success');
