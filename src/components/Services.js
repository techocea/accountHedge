        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-blue-900 font-bold">Why MYOB Cloud Hosting!</h2>
                        
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-blue-900'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-blue-900">&nbsp;  From Startup to Medium Scale, We are the Good among the Best Cloud Software Solution in the market.</h2>
                    </div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">Data Security</h2>
                                    <p className="text-md font-medium">
                                    Proactive data security with automated backup, recovery, and continuity solutions for seamless business operations.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} />
                                    <h2 className="font-semibold my-4 text-2xl text-center">5 Minute Support Response</h2>
                                    <p className="text-md font-medium">
                                    Get a human response within 5 Minutes from the Technical Support Team. It is a hallmark of our customer-centric approach.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-2xl text-center ">D24x7 Assistance</h2>
                                    <p className="text-md font-medium">
                                    Technical assistance available round-the-clock to troubleshoot issues and keep your system up and running.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} />
                                    <h2 className="font-semibold my-4 text-2xl text-center ">Budget friendly</h2>
                                    <p className="text-md font-medium">
                                        Pay less and Gain more. We are always count the numbers how many customers we have not money how much we earn.
                                    </p>
                                </div>
                            </div>                    
                        </div>
